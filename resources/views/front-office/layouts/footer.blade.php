 <footer id="footer" class="footer background-white">
                     ...
                     <div class="col-xl-3 col-md-6 col-12">
                         <div class="footer-infor">
                             ...
                             <ul>
                                 ...
                                 <li>
                                     <p>Email: <a href="#">abdo@abdo.com</a></p>
                                 </li>
                                 <li>
                 ...
                 <div class="row">
                     <div class="col-12">
                         <div class="footer-bottom-wrap d-flex gap-20 flex-wrap justify-content-between align-items-center">
                             <div class="footer-menu_item">© 2024 Abdo. All Rights Reserved</div>
 ...
 <div class="offcanvas offcanvas-end canvas-search" id="canvasSearch">
     <div class="canvas-wrapper">
         <header class="tf-search-head border-0">
         ...
         <div class="modal-content">
             ...
             <div class="tf-login-form">
                 <form class="" id="login-form" accept-charset="utf-8">
                     <div id="alert-placeholder-login"></div>
                     <div class="tf-field style-1">
                         <input class="tf-field-input tf-input" placeholder=" " id="email-login" type="email" name="email">
                         <label class="tf-field-label" for="email">Email *</label>
                     </div>
                     <div class="tf-field style-1">
                         <input class="tf-field-input tf-input" placeholder=" " type="password" id="password-login" name="Password">
         ...
         <div class="modal-content">
             ...
             <div class="tf-login-form">
                 <form id="register-form">
                     <div id="alert-placeholder"></div> <!-- Placeholder for alert -->

                     <div class="tf-field style-1">
                         <input class="tf-field-input w-100 tf-input" placeholder=" " type="text" name="name" id="name">
                     ...
                     <div class="tf-field style-1">
                         <input class="tf-field-input w-100 tf-input" placeholder=" " type="phone" name="phone" id="phone">
                         <label class="tf-field-label" for="phone">Phone *</label>
                     </div>
                     <div class="tf-field style-1">
                         <input class="tf-field-input w-100 tf-input" placeholder=" " type="address" name="address" id="address">
                         <label class="tf-field-label" for="address">Address *</label>
                     </div>
                     <div class="tf-field style-1">
                         <input class="tf-field-input w-100 tf-input" placeholder=" " type="password" name="password" id="password">
                         <label class="tf-field-label" for="password">Password *</label>
                     </div>
                     <div class="tf-field style-1">
                         <input class="tf-field-input w-100 tf-input" placeholder=" " type="password" name="password_confirmation" id="password-confirm">
                         <label class="tf-field-label" for="password-confirm">Confirm Password *</label>
                     </div>
                     <div class="bottom">
                         <div class="w-100">
