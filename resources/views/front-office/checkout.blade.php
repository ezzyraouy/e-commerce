                ...
                <div class="tf-cart-footer-inner">
                    ...
                    <form class="tf-page-cart-checkout widget-wrap-checkout">
                            ...
                            @foreach($orders->OrderItems as $item)
                                <li class="checkout-product-item">
                                    ...
                                    <div class="content">
                                        ...
                                        <span class="price">{{$item->quantity}} * {{$item->product->price}}</span>
                                    </div>
                                </li>
                            @endforeach
                        </ul>
                        ...
                        <div class="d-flex justify-content-between line pb_20">
                            ...
                            <h6 class="total fw-5">{{$orders->total_amount}} <span class="currency">Dhs</span></h6>
                        </div>
                        <div class="wd-check-payment">
                            <div class="fieldset-radio mb_20">
                                <input type="radio" name="payment" id="creditcard" class="tf-check" checked>
                                <label for="creditcard">Credit Card</label>
                            </div>
                            <div class="fieldset-radio mb_20">
                                <input type="radio" name="payment" id="applepay" class="tf-check" >
                                <label for="applepay">Apple Pay</label>

                            </div>
                            <div class="fieldset-radio mb_20">
                                <input type="radio" name="payment" id="paypal" class="tf-check" >
